...
#region Collection
        List<Product> listOfWeapon = new List<Product>
            {
                ...
                //new Product("Благословенный Бросок Апокалипсиса", 1022, 12, 1.5),
        ...
        public void EnchantFunction(ref int g, ref int k)
        {
            ...
            int oneClickEnchantPAttack = (int) Math.Ceiling(selectedItem.SortOfPWeapon * selectedItem.BlessOrSimple); //базовая прибавка
            
            int oneClickEnchantMAttack = (int)Math.Ceiling(5 * selectedItem.BlessOrSimple);
